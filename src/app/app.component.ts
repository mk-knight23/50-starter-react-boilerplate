...
import { LucideAngularModule, Info, Github } from 'lucide-angular';
  ...
  template: `
    <div class="min-h-screen flex flex-col transition-colors duration-500" [class.dark]="settingsService.isDarkMode()" [class.light]="!settingsService.isDarkMode()">
      ...
      <nav
        ...
        [class.border-slate-200]="!settingsService.isDarkMode()"
        [class.border-white/5]="settingsService.isDarkMode()"
        [class.bg-white/80]="!settingsService.isDarkMode()"
        [class.bg-slate-950/80]="settingsService.isDarkMode()"
        role="navigation"
      ...
      >
         <div class="flex items-center space-x-3">
            ...
            <h1 class="text-xl font-display font-black tracking-tight uppercase" [class.text-white]="settingsService.isDarkMode()">
         ...
         <div class="flex items-center space-x-6">
            ...
            >
              <svg *ngIf="settingsService.isDarkMode()" class="text-amber-400" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><path d="M12 1v2"/><path d="M12 21v2"/><path d="M4.22 4.22l1.42 1.42"/><path d="M18.36 18.36l1.42 1.42"/><path d="M1 12h2"/><path d="M21 12h2"/><path d="M4.22 19.78l1.42-1.42"/><path d="M18.36 5.64l1.42-1.42"/></svg>
              <svg *ngIf="!settingsService.isDarkMode()" class="text-slate-400" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
            </button>
            <a
      ...
      <main class="flex-1">
         ...
         <section class="max-w-7xl mx-auto px-10 py-32 space-y-16">
            <div class="max-w-3xl space-y-8">
               ...
               <h2 class="text-6xl md:text-8xl font-display font-black tracking-tighter leading-[0.85] uppercase" [class.text-white]="settingsService.isDarkMode()">
                  Ship <br />
                  <span class="gradient-heading italic font-light">Resilient</span> <br />
                  Applications.
               </h2>
               <p class="text-xl leading-relaxed max-w-xl transition-colors duration-300" [class.text-slate-500]="!settingsService.isDarkMode()" [class.text-slate-400]="settingsService.isDarkMode()">
               ...
               <div class="flex flex-wrap gap-4 pt-4">
                  <button class="px-10 py-4 transition-colors rounded-2xl font-black text-lg flex items-center group cursor-pointer"
                    [class.bg-slate-900]="!settingsService.isDarkMode()"
                    [class.text-white]="!settingsService.isDarkMode()"
                    [class.bg-white]="settingsService.isDarkMode()"
                    [class.text-slate-950]="settingsService.isDarkMode()"
                    (click)="recordClick()"
                  >
                     Get Started
                  ...
                  <button class="px-10 py-4 glass border rounded-2xl font-black text-lg transition-colors cursor-pointer"
                    [class.border-slate-200]="!settingsService.isDarkMode()"
                    [class.border-white/10]="settingsService.isDarkMode()"
                    [class.text-white]="settingsService.isDarkMode()"
                    (click)="recordClick()"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" role="list" aria-label="Features">
               <div *ngFor="let feature of features" class="card-prime space-y-6 group" role="listitem" (click)="recordClick()">
                  <div class="w-12 h-12 rounded-2xl flex items-center justify-center transition-colors"
                    [class.bg-slate-50]="!settingsService.isDarkMode()"
                    [class.bg-white/5]="settingsService.isDarkMode()"
                  ...
                  <div class="space-y-2">
                     <h3 class="text-xl font-bold uppercase tracking-tight" [class.text-white]="settingsService.isDarkMode()">{{ feature.title }}</h3>
                     <p class="text-sm leading-relaxed transition-colors duration-300" [class.text-slate-500]="!settingsService.isDarkMode()" [class.text-slate-400]="settingsService.isDarkMode()">{{ feature.desc }}</p>
                  </div>
               </div>
            </div>
         </section>
         ...
         <!-- Comparison -->
         <section class="py-32 transition-colors duration-300" [class.bg-slate-950]="settingsService.isDarkMode()" [class.bg-slate-50]="!settingsService.isDarkMode()">
            <div class="max-w-7xl mx-auto px-10 grid lg:grid-cols-2 gap-20 items-center">
               <div class="space-y-8">
                  <h3 class="text-4xl font-display font-black uppercase tracking-tighter italic" [class.text-white]="settingsService.isDarkMode()">
                  ...
                  <div class="space-y-6">
                     <div *ngFor="let item of advantages" class="flex items-start space-x-4">
                        ...
                        <p class="text-sm leading-relaxed" [class.text-slate-400]="settingsService.isDarkMode()" [class.text-slate-500]="!settingsService.isDarkMode()">
                          <span [class.text-white]="settingsService.isDarkMode()" class="font-bold">{{ item.label }}:</span> {{ item.text }}
                        </p>
                     </div>
                  </div>
               </div>
               <div class="relative">
                  ...
                  >
                     ...
                     >
                        <div class="w-12 h-12 rounded-2xl flex items-center justify-center transition-colors"
                          [class.bg-white/5]="settingsService.isDarkMode()"
                          [class.bg-slate-100]="!settingsService.isDarkMode()"
                        >
                        ...
                        <div>
                           <h4 class="font-bold" [class.text-white]="settingsService.isDarkMode()">Signals Core</h4>
                           <p class="text-[10px] font-black uppercase tracking-widest" [class.text-slate-500]="settingsService.isDarkMode()" [class.text-slate-400]="!settingsService.isDarkMode()">Fine-grained Reactivity</p>
                        </div>
                     </div>
         ...
         <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
            <div class="space-y-6 max-w-xs">
               <div class="flex items-center space-x-2">
                  ...
                  <span class="font-display font-black text-lg tracking-tighter uppercase" [class.text-white]="settingsService.isDarkMode()">AngularPrime</span>
               </div>
               <p class="text-sm leading-relaxed font-medium italic transition-colors duration-300" [class.text-slate-500]="!settingsService.isDarkMode()" [class.text-slate-400]="settingsService.isDarkMode()">
            ...
            <nav class="grid grid-cols-2 md:grid-cols-3 gap-16 uppercase tracking-widest text-[10px] font-black" aria-label="Footer navigation">
               <div class="space-y-4">
                  <p class="transition-colors duration-300" [class.text-slate-400]="!settingsService.isDarkMode()" [class.text-slate-500]="settingsService.isDarkMode()">Framework</p>
               ...
               <div class="space-y-4">
                  <p class="transition-colors duration-300" [class.text-slate-400]="!settingsService.isDarkMode()" [class.text-slate-500]="settingsService.isDarkMode()">Resources</p>
                  <div class="flex flex-col gap-3">
               ...
               <div class="space-y-4">
                  <p class="transition-colors duration-300" [class.text-slate-400]="!settingsService.isDarkMode()" [class.text-slate-500]="settingsService.isDarkMode()">Project</p>
                  <div class="flex flex-col gap-3">
